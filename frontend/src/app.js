    ...
    >
      ...
      <div className="certification">
        ...
        <div className="certificate-container">
          <img src={Mern} className="cert-img-container" loading="lazy" />
          <img src={Aws} className="cert-img-container" loading="lazy" />
          <img src={Java_cert} className="cert-img-container" loading="lazy" />
          <img src={CrewAI} className="cert-img-container" loading="lazy" />
          <img src={MongoDB} className="cert-img-container" loading="lazy" />
          <img src={Aws_1} className="cert-img-container" loading="lazy" />
          <img src={Aws_2} className="cert-img-container" loading="lazy" />
          <img src={Aws_3} className="cert-img-container" loading="lazy" />
          <img src={Nptel_1} className="cert-img-container" loading="lazy" />
          <img src={Nptel_2} className="cert-img-container" loading="lazy" />
        </div>
      </div>
        ...
        >
          ...
          <div>
            ...
            >
              ...
              />
              <a href="https://github.com/Vetrikanth1209" target="_blank">
            ...
            >
              ...
              />
              <a href="https://www.instagram.com/vetree_1209/" target="_blank">
